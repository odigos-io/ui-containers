...
import { CenterThis, DATA_CARD_FIELD_TYPES, DataCard, DataCardProps, FadeLoader, Status } from '@odigos/ui-components'
...
const Describe: FC<DescribeProps> = ({ source, fetchDescribeSource }) => {
  ...
  return describe.pods.map(({ podName, nodeName, phase, containers }) => {
    const podHasErrors =
