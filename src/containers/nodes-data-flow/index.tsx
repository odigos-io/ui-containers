...
const NodeDataFlow: React.FC<Props> = ({ nodes, edges, onNodeClick, onNodesChange, onEdgesChange }) => {
  const nodeTypes = {
    ...
    // @ts-ignore
    [NODE_TYPES.SCROLL]: (props) => <ScrollNode handleNodeClick={onNodeClick} {...props} />,
